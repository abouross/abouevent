...
class Venue extends Model
{
    ...
    static protected $sortable = ['id', 'created_at', 'updated_at', 'name'];
    static protected $defaultSort = ['created_at' => 'desc'];
    static protected $searchable = ['name', 'description', 'address'];

    protected $guarded = ['created_at', 'updated_at', 'id', 'image_id'];
    ...
    {
        return $this->belongsToMany(Event::class, 'events_venues');
    }
    ...
    public function rawEventsCountAttribute()
    {
        return 'count(events)';
    }
